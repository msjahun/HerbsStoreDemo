...
namespace HerbsStore.Migrations
{
    ...
    [Migration("20191231160614_addedDiseaseDescription")]
    partial class addedDiseaseDescription
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HerbsStore.Libraries.HS.Core.Domain.Diseases.Disease", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("DiseasesFlat");
            ...
            modelBuilder.Entity("HerbsStore.Libraries.HS.Core.Domain.Diseases.HospitalDisease", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("HospitalDisease");
                });

            modelBuilder.Entity("HerbsStore.Libraries.HS.Core.Domain.Diseases.ProductDisease", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HerbsStore.Libraries.HS.Core.Domain.Diseases.HospitalDisease", b =>
                {
                    b.HasOne("HerbsStore.Libraries.HS.Core.Domain.Diseases.Disease", "Disease")
                        .WithMany("HospitalDiseases")
                        .HasForeignKey("DiseaseId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("HerbsStore.Libraries.HS.Core.Domain.Hospitals.Hospital", "Hospital")
                        .WithMany("HospitalDiseases")
